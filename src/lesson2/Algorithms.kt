 ...
 *
 * Сложность: в худшем случае O(l(nm)^2 + lw), где l - макс. длина слова (можно считать константой)
 *                                                 n x m - размер матрицы букв
 *                                                 w - количество слов
 * Память: в худшем случае O((nm)^2 + l^k), где k - число различных букв в матрице
 */
